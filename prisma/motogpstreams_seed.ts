...
const pageData: Prisma.PageCreateInput[] = [
  {
    ...
    title: "About",
    content: `
      <h2>Tentang MOTOGPSTREAMS</h2>
      <p>
        MOTOGPSTREAMS adalah situs nonton live streaming MotoGP.
      </p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>
        Privasi pengunjung merupakan hal yang penting bagi MOTOGPSTREAMS.
      ...
      <p>
        MOTOGPSTREAMS dapat mengumpulkan informasi tertentu secara otomatis,
      ...
      <p>
        MOTOGPSTREAMS dapat menggunakan cookies atau teknologi serupa untuk
      ...
      <p>
        MOTOGPSTREAMS dapat memperbarui Kebijakan Privasi ini dari waktu ke waktu.
      ...
      <p>
        ...
        silakan menghubungi MOTOGPSTREAMS melalui kontak yang tersedia di situs.
      </p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>
        Informasi yang tersedia di MOTOGPSTREAMS disediakan untuk tujuan
  ...
  },
  {
    ...
    content: `
      ...
      <p>
        Dengan mengakses dan menggunakan MOTOGPSTREAMS, Anda menyetujui
...
const siteSettingData: Prisma.SiteSettingCreateInput = {
  ...
  siteUrl: "https://www.motogpstreams.com",
  ...
  googleAnalyticsId: "G-MSJQ10MVM6",
  googleSiteVerification: "",
  socialLinks: {
    create: [
      {
        name: "MOTOGPSTREAMS X",
        platform: "twitter",
        url: "https://x.com/nontonmotogp",
      },
      {
        name: "MOTOGPSTREAMS Telegram",
        platform: "telegram",
        url: "https://t.me/+qMM92ZK59mVmYzg1",
      },
      {
        name: "MOTOGPSTREAMS Facebook",
        platform: "facebook",
        url: "https://www.facebook.com/MOTOGPSTREAMSnet",
      },
      {
        name: "MOTOGPSTREAMS YouTube",
        platform: "youtube",
        url: "https://youtube.com/@MOTOGPSTREAMSnet",
      },
      {
        name: "MOTOGPSTREAMS TikTok",
        platform: "tiktok",
        url: "https://t.me/+qMM92ZK59mVmYzg1",
      },
    ],
